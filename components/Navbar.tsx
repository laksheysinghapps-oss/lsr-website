...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-lsr-black/90 backdrop-blur-md py-2 border-b border-white/10' : 'bg-transparent py-6'}`}
