...
export const SECTOR_MAPS: SectorMap[] = [
  ...
  { id: 'sector-37-pace-city-2', name: 'Sector 37/Pace City II', description: 'An established industrial and commercial belt on NH 8 in Sector 37, known for warehousing, light manufacturing and corporate offices.', thumb: '/images/sector-maps/pace-city-2-thumb.jpg', zoom: '/images/sector-maps/pace-city-2-zoom.jpg', source: 'HUDA, Approved Sector Layout Plan, Sector 37, Pace City II' },
...
<p>Executing a PoA from abroad. The PoA must be executed in the country where the NRI resides and then apostilled (for Hague Convention countries including the US, UK, Canada, Singapore, UAE, and Australia). For non Hague countries, the document is notarised and attested by the Indian consulate. Once in India, the PoA is typically registered with the local Sub Registrar's office before being used for property transactions.</p>
<p>Who should hold your PoA. A trusted family member resident in India is the most common choice. If no family member is available, LSR Realty can recommend experienced property attorneys in Gurgaon who handle NRI PoA assignments as a regular part of their practice.</p>
