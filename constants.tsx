...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    metaDescription: 'Plain-English guide to the Gurgaon Manesar Master Plan 2031: land-use zones, transport corridors, metro expansion and exactly what it means for your property investment in Gurugram.',
