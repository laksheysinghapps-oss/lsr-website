...
<figure class="my-10">
  <img src="/images/gcer-8-lane-road.png" alt="GCER 8-lane road widening Golf Course Extension Road Gurgaon infrastructure" class="w-full rounded-sm object-cover" style="max-height:420px;object-position:center" draggable="false" oncontextmenu="return false" />
  <figcaption class="text-center text-xs text-gray-500 mt-3">The planned 8-lane widening of Golf Course Extension Road will dramatically improve connectivity across the corridor.</figcaption>
</figure>
