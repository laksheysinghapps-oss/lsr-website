...
export const SECTOR_MAPS: SectorMap[] = [
  { id: 'gurgaon-manesar-master-plan', name: 'Gurugram Manesar Master Plan 2031', description: 'The complete Gurugram Manesar Urban Complex master plan, showing all sectors, land use zones, transport corridors and the proposed metro route across the city.', thumb: '/images/sector-maps/gurgaon-manesar-master-plan-thumb.jpg', zoom: '/images/sector-maps/gurgaon-manesar-master-plan-zoom.jpg', source: 'Gurugram Manesar Urban Complex, Master Plan 2031' },
