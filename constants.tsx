...
`,
  ...
  },
  {
    ...
    published: false,
    content: `
<style>.prose h2{font-size:1.75rem;font-weight:700;color:#ffffff;margin:2.5rem 0 1rem;line-height:1.3}.prose p{color:#d1d5db;line-height:1.8;margin:0 0 1.25rem;text-align:justify}.prose a{color:#c9a54a;text-decoration:underline}.prose strong{color:#ffffff;font-weight:700}</style>
...
<p>If you are an NRI evaluating a property investment in Gurgaon, the right starting point is a conversation about your budget, investment horizon, repatriation plans, and the account structure you intend to use. Everything else — the specific project, the sector, the unit type — follows from that. Reach our NRI Desk at <a href="/contact">marketing@lsrrealty.com</a> or call +91 8448660019.</p>
`,
  },
  {
