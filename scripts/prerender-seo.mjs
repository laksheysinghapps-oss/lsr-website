...
const staticRoutes = [
  ...
  {
    route: '/maps',
    title: 'Gurgaon Map & Sector Layout Plans | LSR Realty',
    description: 'Explore Gurgaon sector maps and layout plans, including the Gurgaon Manesar Master Plan 2031 for the Gurugram Urban Complex.',
  ...
  },
  {
    ...
    keywords: 'Gurgaon Master Plan 2041, Gurugram Master Plan 2041, Gurgaon Master Plan 2041 map, GMDA infrastructure',
